...
enum web49_opcode_enum_t {
    ...
    WEB49_OPCODE_I32_EXTEND8_S = 0xC0,
    WEB49_OPCODE_I32_EXTEND16_S = 0xC1,
    WEB49_OPCODE_I64_EXTEND8_S = 0xC2,
    WEB49_OPCODE_I64_EXTEND16_S = 0xC3,
    WEB49_OPCODE_I64_EXTEND32_S = 0xC4,
