...
enum web49_interp_instr_enum_t {
    ...
    WEB49_OPCODE_I32_EQ_TOP_CONST,
    WEB49_OPCODE_I32_NE_TOP_CONST,
    WEB49_OPCODE_I32_LT_S_TOP_CONST,
    WEB49_OPCODE_I32_LT_U_TOP_CONST,
    WEB49_OPCODE_I32_GT_S_TOP_CONST,
    WEB49_OPCODE_I32_GT_U_TOP_CONST,
    WEB49_OPCODE_I32_LE_S_TOP_CONST,
    WEB49_OPCODE_I32_LE_U_TOP_CONST,
    WEB49_OPCODE_I32_GE_S_TOP_CONST,
    WEB49_OPCODE_I32_GE_U_TOP_CONST,
    WEB49_OPCODE_I32_ADD_TOP_CONST,
    WEB49_OPCODE_I32_SUB_TOP_CONST,
    WEB49_OPCODE_I32_MUL_TOP_CONST,
    WEB49_OPCODE_I32_DIV_S_TOP_CONST,
    WEB49_OPCODE_I32_DIV_U_TOP_CONST,
    WEB49_OPCODE_I32_REM_S_TOP_CONST,
    WEB49_OPCODE_I32_REM_U_TOP_CONST,
    WEB49_OPCODE_I32_AND_TOP_CONST,
    WEB49_OPCODE_I32_OR_TOP_CONST,
    WEB49_OPCODE_I32_XOR_TOP_CONST,
    WEB49_OPCODE_I32_SHL_TOP_CONST,
    WEB49_OPCODE_I32_SHR_S_TOP_CONST,
